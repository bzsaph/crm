                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="card flex-row align-items-center align-items-stretch border-0">
                                ...
                                <div class="col-8 py-3 bg-primary rounded-right">
                                    ...
                                    <div class="h4 mt-0">
                                        <small><a href="allcompany" class=" bg-primary ">Companys That offer internship
                                            </a></small>
                                    </div>
                            ...
                            <em class="fa fa-arrow-right"></em>
                                ...
                                <div class="text-center py-4">
                                    <div class="easypie-chart easypie-chart-lg" data-easypiechart="" data-percent="70"
                                        ...
                                        {{-- <span>{{ $post }}</span> --}}
                                        <canvas height="100% !important" width="217"
                                            style="height: 145px; width: 145px;"></canvas>
                                    </div>
                                </div>
                                <div class="text-center" data-sparkline="" data-bar-color="#23b7e5" data-height="30"
                                    data-bar-width="5" data-bar-spacing="2" data-values=""><canvas width="131" height="30"
